...
Keep exact pulse URLs or IDs and version names. Read every relevant ticket or say what blocked you. Read board fields; do not guess them from urgency, comments, colors, or order. If "current sprint" could mean either customer, check both boards.
