...
- `Done`: only when explicitly allowed, or object-level low-risk + fully verified.
...
- `Assignee`: if missing and task is executable, set Sil Veltman (`23d00f52-372e-4f47-b96e-d1bec34fb9d3`).
...
Top section is for assignee instructions only. Keep it extremely concise.
