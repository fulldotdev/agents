...
| com.fulldev.pool-usage (launchd) | daily 08:03 | `~/.agents/skills/environment/scripts/pool-usage.py --telegram`, weekly quota left per pooled account to Telegram System |
