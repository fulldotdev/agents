...
Custom skills and `~/.agents/always/AGENTS.md` follow its plain style, plus these rules.
...
- Say each rule once. Style, permission, and evidence rules live in `~/.agents/always/AGENTS.md`, browser rules in `browser`. Do not restate them in a skill.
