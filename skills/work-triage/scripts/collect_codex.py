...
from triage_common import add_common_args, base_result, compact_text, emit, iso_utc, parse_iso, window_from_args
    ...
    for r in rows:
        ...
        items.append({
            ...
            "reference": {
                ...
                "deep_read_hint": f"collect_codex.py --thread-id {r.get('id')} --format yaml",
            },
        })
    return items
