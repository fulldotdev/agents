...
When revising a price that was already presented, keep that version, its source, and when it was presented. Explain major changes and keep proposed, approved, and customer-presented amounts apart. Keep calculation notes with the scope.

Lead with the recommended amount or change, what it covers, and any uncertainty that affects the price. Compare with past work you have verified, and adjust for reuse, supplied designs, data readiness, and integration risk. Make underpricing visible. Charge shared costs once.
